...
#define NODE_MAIN_LOGGER_NAME "spin_until_future_complete_relay_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libservices_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spin_until_future_complete::RelayServerNode>";
